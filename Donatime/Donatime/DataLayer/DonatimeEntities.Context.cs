...
namespace Donatime.DataLayer
{
    ...
    public partial class DonatimeEntities : DbContext
    {
        public DonatimeEntities()
            : base("name=DonatimeEntities")
        {
        }
        ...
        public virtual DbSet<Problematica> Problematica { get; set; }
